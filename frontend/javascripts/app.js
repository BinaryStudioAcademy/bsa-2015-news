...
var getHeader = function() {
	...
	request.onreadystatechange = function() {
		...
		if (request.status != 200) {
			...
			menuBtn.setAttribute("id", "menu-gen");
			menuBtn.setAttribute("ng-click", "newsCtrl.toggleGenMenu()");
			menuBtn.innerHTML = '<i class="fa fa-bars"></i>';
			var btnContainer = document.getElementsByClassName('hdr-buttons')[0];
			var search = document.getElementById('searchBar');
			btnContainer.insertBefore(menuBtn, search);
		}
	};
};
getHeader();
